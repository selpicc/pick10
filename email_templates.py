...
def build_followup(row: dict, round_no: int = 1) -> dict:
    ...
    if round_no <= 1:
        ...
        # 2차(마지막): 부담을 내려놓되 문은 활짝 열어둔다.
        # 재촉하지 않고, 소개서를 다시 첨부해 '천천히 보시고 연락 달라'로 마무리.
        body_lines = [
            "앞서 두 번 연락드렸는데, 바쁘신 와중에 번거로우셨다면 너른 양해 부탁드립니다.",
            "편히 살펴보실 수 있도록 셀픽 소개서를 다시 한번 첨부드립니다.",
            "급하게 결정하실 일은 아니니, 여유 있으실 때 천천히 보신 후 "
            "관심이 생기시면 편하게 연락 주시면 감사하겠습니다.",
        ]
        closing = "감사합니다."
